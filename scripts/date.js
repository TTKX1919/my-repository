<script language="JavaScript">
          ...
          function YYMMDD() {
            var cl = '<font color="000000" STYLE="font-size:13pt;">';
            if (now.getDay() == 0)
              cl = '<font color="#000000" STYLE="font-size:13pt;">';
            if (now.getDay() == 6)
              cl = '<font color="#000000" STYLE="font-size:13pt;">';
            return (
              cl + "&nbsp;&nbsp;" + SY + "年" + (SM + 1) + "月" + "</font>"
          ...
          function weekday() {
            ...
            if (now.getDay() == 0)
              cl = '<font color="green" STYLE="font-size:13pt;">';
            if (now.getDay() == 6)
              cl = '<font color="green" STYLE="font-size:13pt;">';
          ...
          function solarDay3() {
            ...
            var cl = '<font color="#000000" STYLE="font-size:12pt;">';
          ...
          function setCalendar() {
            ...
            document.write(
              YYMMDD() +
                ...
                SD +
                "日</font><font face='Arial' size='4'>&nbsp;"
            );
            document.write(
              "&nbsp;&nbsp;&nbsp;&nbsp;" +
                weekday() +
                "&nbsp;&nbsp;&nbsp;&nbsp;" +
                "<font id=ClockTime size='4' color=red></font>&nbsp;&nbsp;&nbsp;&nbsp;"
            );
            document.write(
              solarDay1() +
                "&nbsp;&nbsp;" +
